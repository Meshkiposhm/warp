...
### برای اسکن ای پی روی ویندوز فایل [win_warp_ip.zip](https://github.com/Meshkiposhm/warp/blob/main/endip/win_warp_ip.zip) دانلود کنید و از حالت فشرده خارج کنید سپس فایل win_scaner را اجرا کنید. 
---
---
...
inatall
```
bash <(curl -fsSL https://raw.githubusercontent.com/Meshkiposhm/warp/main/install.sh)
```

![15](https://raw.githubusercontent.com/Meshkiposhm/configs/main/media/15.jpg)
...
install
```
bash <(curl -fsSL https://raw.githubusercontent.com/Meshkiposhm/warp/main/endip/install.sh)
```
![16](https://raw.githubusercontent.com/Meshkiposhm/configs/main/media/16.jpg)
...
## Credits.
[Meshkiposhm](https://github.com/Meshkiposhm/warp.sh)
